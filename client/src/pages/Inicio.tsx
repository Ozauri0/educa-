		...
		<IonPage>
			...
			<IonContent fullscreen>
				...
				<IonCard>
					<img
						alt="Educa +"
						src="https://prensa.uct.cl/wp-content/uploads/2020/09/IMG_Educa-Blcakboard.png"
					/>
					<IonCardHeader>
					...
					<IonCardContent>
						<p>
							aqui podras encontrar cursos para poder utilizar educa+ de forma
							correcta
						</p>
					</IonCardContent>
				</IonCard>
				<IonCard href="/Asesoria">
					<img
						alt="Ayduantias"
						src="https://www.pedagogiapucv.cl/wp-content/uploads/2018/03/ayudantia2.jpg"
					/>
					<IonCardHeader>
						<IonCardSubtitle>
							Revisa tus solicitudes de ayudantia
						</IonCardSubtitle>
				...
				<IonCard href="/Foro">
					<img
						alt="Clases"
						src="https://prensa.uct.cl/wp-content/uploads/2019/04/300_sociologia.jpg"
					/>
					<IonCardHeader>
